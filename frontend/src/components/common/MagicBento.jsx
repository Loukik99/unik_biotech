...
// Brand green glow (r, g, b) replaces the original purple.
const DEFAULT_GLOW_COLOR = '93, 187, 99';
const MOBILE_BREAKPOINT = 768;

// Fallback content if no `cards` prop is supplied.
const fallbackCards = [
...
/** Shared inner markup: extends the Bento card with product details. */
  ...
  <>
    ...
    <div className="magic-bento-card__image">
      <ProductImage
        src={card.image}
        alt={card.title}
        fallback={<Package className="magic-bento-card__image-fallback" aria-hidden="true" />}
      />
    </div>
    ...
    <div className="magic-bento-card__content">
      ...
      {card.href && (
        <Link to={card.href} className="magic-bento-card__cta">
          {card.cta || 'Explore'}
          <ArrowRight className="magic-bento-card__cta-arrow" size={16} />
        </Link>
      )}
    </div>
  </>
